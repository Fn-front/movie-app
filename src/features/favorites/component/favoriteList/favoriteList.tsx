...
import type { FavoriteItem, MovieFavoriteInfo } from '@/lib/api/favorites/favorites';
 ...
 * FavoriteListコンポーネント
 */
export const FavoriteList = memo<FavoriteListProps>(
 ...
 * FavoriteTileコンポーネント
 */
const FavoriteTile = memo<FavoriteTileProps>(
  function FavoriteTile({ item, onFavoriteToggle, favoriteDisabled }) {
