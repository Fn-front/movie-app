-- ============================================
-- sync_trending_movies RPC関数 — RLSバイパス修正
-- ============================================
-- SECURITY DEFINER関数でもRLSが適用されるため、
-- SET search_path と合わせてRLSをバイパスするよう修正
...
BEGIN
  -- RLSを一時的に無効化（SECURITY DEFINER関数内でのみ有効）
  ALTER TABLE trending_movies DISABLE ROW LEVEL SECURITY;
